...
class RequirementsParser:
    ...
    def update_requirement_version(self, file_path: str, package_name: str, new_version: str) -> bool:
        """
        ...
        for req in requirements:
            if req.name.lower() == package_name.lower() and not req.is_comment and not req.is_include:
