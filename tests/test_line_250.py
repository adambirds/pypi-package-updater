...
class TestLine250:
    ...
    async def test_line_250_skipped_packages_logging(self):
        ...
        with patch.object(updater.pypi_client, 'check_package_updates', return_value=[mock_package_info]):
            ...
            with patch.object(updater, '_update_single_package', side_effect=mock_update_single_package):
    ...
    async def test_line_250_alternative_skipped_scenario(self):
        ...
        with patch.object(updater.pypi_client, 'check_package_updates', return_value=mock_package_infos):
